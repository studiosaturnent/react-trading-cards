...
ReactDOM.render(
  <TradingCard name="Pookie" skill ="rock throwing" imgUrl="/static/img/polymorphism.jpeg" />,
  document.querySelector('#pookie'),
);
